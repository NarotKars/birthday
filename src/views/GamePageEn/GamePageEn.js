...
export default function LoginPage(props) {
  ...
  var questions=["How old is Greta?", "What is Greta's favourite color?", "Who does Greta love the most?", 
                 "What's her favourite car?", "Greta's favourite TV series?","What's the best present Greta ever received?", "Her favourite writer is..."];
  var radioOne=["19", "Pink", "Narot", "Land Rover", "Game of thrones","Flowers", "Agatha Christie"];
  var radioTwo=["20", "Black", "Kars", "Mercedes", "Supernatural","Balloons", "Oscar Wilde"];
  var radioThree=["23", "Blue", "Karapet", "Mini Cooper", "Merlin","Notebook", "Stephen King"];
  var radioFour=["25", "Purple", "Karlos", "VolksWagen", "Grimm", "This website","Jane Austen"];
  ...
  function FinishTheGame()
  {
    if(selectedEnabled==="")
    {
      setHelperText("Please select one of the options");
    }
    else
    {
